...
# }
#  parser.add_argument('--data_folder', type=str, dest='data_folder',default = ds.as_mount(), help='data folder mounting point')
# args = parser.parse_args()
# print("Argument 5: %s" % args.data_folder)
