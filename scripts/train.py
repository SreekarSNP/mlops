...
block_blob_service = BlockBlobService(account_name='mlopsws4303756080',
                              account_key='kJLGmYdKaOaO98NUeIgQi3w7eTkGhX5VEtYewosK7ZmmwYKm0O/jpX+O3tuwnlRiZwGb3EUmSptdGg0iJtAFmw==' )
# get data from blob storage in the form of bytes
blob_byte_data = block_blob_service.get_blob_to_bytes('azureml-blobstore-195434fb-de3c-4c91-9ec8-d8951bc2bae8','final_data.csv')
...
final_ds.register(workspace=ws, name="Diabetes Dataset new", description="Diabetes Dataset",
...
model = RandomForestClassifier(n_estimators=100,criterion='gini', max_depth=5, min_samples_split=2)
